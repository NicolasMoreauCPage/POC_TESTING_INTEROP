...
import fr.cpage.interfaces.hapi.custom.group.ADT_A41_PATIENT;
import fr.cpage.interfaces.hapi.custom.segment.ZFP;
import fr.cpage.interfaces.hapi.custom.segment.ZPA;

/**
 * <p>
 * Represents a ADT_A41 message structure (see chapter 3.3.40). This structure contains the following elements:
 * </p>
 * 0: MSH (Message header segment) <b></b><br>
 * 1: SFT (Software Segment) <b>optional repeating</b><br>
 * 2: EVN (EVN - event type segment) <b></b><br>
 * 3: ADT_A41_PATIENT (a Group object) <b>repeating</b><br>
...
public class ADT_A41 extends AbstractMessage {
   ...
   */
  public ADT_A41(final ModelClassFactory factory) {
    super(factory);
    init(factory);
  }
  ...
  private void init(final ModelClassFactory factory) {
    try {
      ...
      this.add(ADT_A41_PATIENT.class, false, true);
      this.add(ZFP.class, false, false);
      this.add(ZPA.class, false, false);
    } catch (final HL7Exception e) {
      CPageLogFactory.getLog(this.getClass()).error("Unexpected error creating ADT_A41 - this is probably a bug in the source code generator.", e);
    }
  }
