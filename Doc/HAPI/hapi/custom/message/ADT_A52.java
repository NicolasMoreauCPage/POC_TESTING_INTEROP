 ...
 *
 * Mouvement - Transfert temporaire : "Annulation de sortie temporaire"
 *
 */
...
import fr.cpage.interfaces.hapi.custom.group.ADT_A52_TRAITANT;
...
/**
 * <p>
 * Represents a ADT_A52 message structure (see chapter 3.3.52). This structure contains the following elements:
 * </p>
 ...
 * </p>
 * 11: ZFU (Identification des unités fonctionnelles des séjours) <b>optional </b></br>
 * 12: ZPA (Identification des informations additionnelles du patient) <b>optional </b></br>
 *
...
public class ADT_A52 extends AbstractMessage {
   ...
   */
  public ADT_A52(final ModelClassFactory factory) {
    super(factory);
    init(factory);
  }
  ...
  private void init(final ModelClassFactory factory) {
    try {
      ...
      this.add(ADT_A52_TRAITANT.class, false, true);
      ...
      CPageLogFactory.getLog(this.getClass()).error("Unexpected error creating ADT_A52 - this is probably a bug in the source code generator.", e);
    }
  }

  /**
   * Returns first repetition of ADT_A52_TRAITANT (a Group object) (Role) - creates it if necessary
   */
  public ADT_A52_TRAITANT getTRAITANT() {
    ADT_A52_TRAITANT ret = null;
    try {
      ret = (ADT_A52_TRAITANT) this.get("TRAITANT");
    } catch (final HL7Exception e) {
  ...
  /**
   * Returns a specific repetition of ADT_A52_TRAITANT (a Group object) (Role) - creates it if necessary throws HL7Exception if the repetition requested is more than one greater than the number of
   * existing repetitions.
   */
  public ADT_A52_TRAITANT getTRAITANT(final int rep) throws HL7Exception {
    return (ADT_A52_TRAITANT) this.get("TRAITANT", rep);
  }

  /**
   * Returns the number of existing repetitions of ADT_A52_TRAITANT
   */
