...
import fr.cpage.interfaces.hapi.custom.group.ADT_A05_INSURANCE2;
...
import fr.cpage.interfaces.hapi.custom.segment.ZFS;
...
public class ADT_A05 extends AbstractMessage {
   ...
   */
  public ADT_A05(final ModelClassFactory factory) {
    super(factory);
    init(factory);
  }
  ...
  private void init(final ModelClassFactory factory) {
    try {
      ...
      this.add(ADT_A05_INSURANCE2.class, false, true);
