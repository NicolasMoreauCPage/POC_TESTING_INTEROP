 ...
 *
 * Mouvement - Mutation et changement de lit : "Mutation d'un patient"
 *
 */
...
import fr.cpage.interfaces.hapi.custom.group.ADT_A02_RESPONSABLE;
import fr.cpage.interfaces.hapi.custom.group.ADT_A02_TRAITANT;
...
/**
 * <p>
 * Represents a ADT_A02 message structure (see chapter 3.3.2). This structure contains the following elements:
 * </p>
 ...
 * 16: PDA (Patient Death and Autopsy) <b>optional </b><br>
 */
/**
 * <p>
 ...
 * </p>
 * 17: ZFU (Identification des unités fonctionnelles des séjours) <b>optional </b></br>
 * 18: ZPA (Identification des informations additionnelles du patient) <b>optional </b></br>
 * 19: ZPV (Informations complémentaires sur le passage à l'hôpital) <b>optional </b></br>
 * 20: ZFT (Identification des périodes tarifaire dans l'unité de soins) <b>optional </b></br>
 * 21: ZFI (Identification des périodes élémentaires en unité de soins) <b>optional </b></br>
 *
...
public class ADT_A02 extends AbstractMessage {
  ...
  /**
   * Creates a new ADT_A02 Group with custom ModelClassFactory.
   */
  public ADT_A02(final ModelClassFactory factory) {
    super(factory);
    init(factory);
  }
  ...
  private void init(final ModelClassFactory factory) {
    try {
      ...
      this.add(ADT_A02_TRAITANT.class, false, true);
      ...
      this.add(ADT_A02_RESPONSABLE.class, false, true);
      ...
      CPageLogFactory.getLog(this.getClass()).error("Unexpected error creating ADT_A02 - this is probably a bug in the source code generator.", e);
    }
  }

  /**
   * Returns first repetition of ADT_A02_TRAITANT (a Group object) (Role) - creates it if necessary
   */
  public ADT_A02_TRAITANT getTRAITANT() {
    ADT_A02_TRAITANT ret = null;
    try {
      ret = (ADT_A02_TRAITANT) this.get("TRAITANT");
    } catch (final HL7Exception e) {
  ...
  /**
   * Returns a specific repetition of ADT_A02_TRAITANT (a Group object) (Role) - creates it if necessary throws HL7Exception if the repetition requested is more than one greater than the number of
   * existing repetitions.
   */
  public ADT_A02_TRAITANT getTRAITANT(final int rep) throws HL7Exception {
    return (ADT_A02_TRAITANT) this.get("TRAITANT", rep);
  }

  /**
   * Returns the number of existing repetitions of ADT_A02_TRAITANT
   */
   ...
   */
  public ADT_A02_RESPONSABLE getRESP() {
    ADT_A02_RESPONSABLE ret = null;
    try {
      ret = (ADT_A02_RESPONSABLE) this.get("RESP");
    } catch (final HL7Exception e) {
      CPageLogFactory.getLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
    }
    return ret;
   ...
   */
  public ADT_A02_RESPONSABLE getRESP(final int rep) throws HL7Exception {
    return (ADT_A02_RESPONSABLE) this.get("RESP", rep);
  }
