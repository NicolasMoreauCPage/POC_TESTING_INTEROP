 ...
 *
 * Mouvement - Transfert temporaire : "Sortie temporaire de l'unité de soins"
 *
 */
...
import fr.cpage.interfaces.hapi.custom.group.ADT_A21_RESPONSABLE;
import fr.cpage.interfaces.hapi.custom.group.ADT_A21_TRAITANT;
...
/**
 * <p>
 * Represents a ADT_A21 message structure (see chapter 3.3.21). This structure contains the following elements:
 * </p>
 ...
 * 17: ZBE (Identification des mouvements de localisation en unité de soin) <b>optional </b></br>
...
public class ADT_A21 extends AbstractMessage {
   ...
   */
  public ADT_A21(final ModelClassFactory factory) {
    super(factory);
    init(factory);
  }
  ...
  private void init(final ModelClassFactory factory) {
    try {
      ...
      this.add(ADT_A21_TRAITANT.class, false, true);
      ...
      this.add(ADT_A21_RESPONSABLE.class, false, true);
      ...
      CPageLogFactory.getLog(this.getClass()).error("Unexpected error creating ADT_A21 - this is probably a bug in the source code generator.", e);
    }
  }

  /**
   * Returns first repetition of ADT_A21_TRAITANT (a Group object) (Role) - creates it if necessary.
   */
  public ADT_A21_TRAITANT getTRAITANT() {
    ADT_A21_TRAITANT ret = null;
    try {
      ret = (ADT_A21_TRAITANT) this.get("TRAITANT");
    } catch (final HL7Exception e) {
  ...
  /**
   * Returns a specific repetition of ADT_A21_TRAITANT (a Group object) (Role) - creates it if necessary throws HL7Exception if the repetition requested is more than one greater than the number of
   * existing repetitions.
   */
  public ADT_A21_TRAITANT getTRAITANT(final int rep) throws HL7Exception {
    return (ADT_A21_TRAITANT) this.get("TRAITANT", rep);
  }

  /**
   * Returns the number of existing repetitions of ADT_A21_TRAITANT.
   */
   ...
   */
  public ADT_A21_RESPONSABLE getRESP() {
    ADT_A21_RESPONSABLE ret = null;
    try {
      ret = (ADT_A21_RESPONSABLE) this.get("RESP");
    } catch (final HL7Exception e) {
      CPageLogFactory.getLog(this.getClass()).error("Unexpected error accessing data - this is probably a bug in the source code generator.", e);
    }
    return ret;
   ...
   */
  public ADT_A21_RESPONSABLE getRESP(final int rep) throws HL7Exception {
    return (ADT_A21_RESPONSABLE) this.get("RESP", rep);
  }
