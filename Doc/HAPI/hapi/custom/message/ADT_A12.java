 ...
 *
 * Mouvement - Mutation et changement de lit : "Annulation d'une mutation"
 *
 */
...
import fr.cpage.interfaces.hapi.custom.group.ADT_A12_TRAITANT;
...
/**
 * <p>
 * Represents a ADT_A12 message structure (see chapter 3.3.12). This structure contains the following elements:
 * </p>
 ...
 * 7: ZBE (Identification des mouvements de localisation en unité de soin) <b>optional </b></br> 8: ZFP (Situation
 * professionnelle) <b>optional </b><br>
 * 9: ZFV (Informations supplémentaires sur la venue) <b>optional </b><br>
 * 10: DB1 (Disability) <b>optional repeating</b><br>
 * 11: OBX (Observation/Result) <b>optional repeating</b><br>
 * 12: DG1 (Diagnosis) <b>optional </b><br>
 * 13: ACC (Accident) <b>optional </b><br>
 */
/**
 * <p>
 * Ajouts des segments spécifiques IHE France , IHE Allemagne et propriétaire CPage ZFU et ZPA en fin de message
 * </p>
...
public class ADT_A12 extends AbstractMessage {
  ...
  /**
   * Creates a new ADT_A12 Group with custom ModelClassFactory.
   */
  public ADT_A12(final ModelClassFactory factory) {
    super(factory);
    init(factory);
  }
  ...
  private void init(final ModelClassFactory factory) {
    try {
      ...
      this.add(ADT_A12_TRAITANT.class, false, true);
      ...
      CPageLogFactory.getLog(this.getClass()).error("Unexpected error creating ADT_A12 - this is probably a bug in the source code generator.", e);
    }
  }

  /**
   * Returns first repetition of ADT_A12_TRAITANT (a Group object) (Role) - creates it if necessary
   */
  public ADT_A12_TRAITANT getTRAITANT() {
    ADT_A12_TRAITANT ret = null;
    try {
      ret = (ADT_A12_TRAITANT) this.get("TRAITANT");
    } catch (final HL7Exception e) {
  ...
  /**
   * Returns a specific repetition of ADT_A12_TRAITANT (a Group object) (Role) - creates it if necessary throws HL7Exception if the repetition requested is more than one greater than the number of
   * existing repetitions.
   */
  public ADT_A12_TRAITANT getTRAITANT(final int rep) throws HL7Exception {
    return (ADT_A12_TRAITANT) this.get("TRAITANT", rep);
  }

  /**
   * Returns the number of existing repetitions of ADT_A12_TRAITANT
   */
