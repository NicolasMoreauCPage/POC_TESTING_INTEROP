...
/**
 * <p>
 * Represents the ADT_A08_INSURANCE Group. A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together. This Group contains the following
 * elements:
 * </p>
...
public class ADT_A08_INSURANCE extends AbstractGroup {

  /**
   * Creates a new ADT_A08_INSURANCE Group.
   */
  public ADT_A08_INSURANCE(final Group parent, final ModelClassFactory factory) {
    ...
    try {
      ...
      CPageLogFactory.getLog(this.getClass()).error("Unexpected error creating ADT_A08_INSURANCE - this is probably a bug in the source code generator.", e);
    }
  }
