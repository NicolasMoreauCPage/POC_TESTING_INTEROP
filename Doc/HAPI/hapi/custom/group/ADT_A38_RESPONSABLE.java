...
/**
 * <p>
 * Represents the ADT_A38_RESP Group. A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together. This Group contains the following elements:
 * </p>
 * 1: ROL (Role) <b>optional repeating</b><br>
 */
public class ADT_A38_RESPONSABLE extends AbstractGroup {

  /**
   * Creates a new ADT_A38_RESP Group.
   */
  public ADT_A38_RESPONSABLE(final Group parent, final ModelClassFactory factory) {
