...
/**
 * <p>
 * Represents the ADT_A54_TRAITANT Group. A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together. This Group contains the following
 * elements:
 * </p>
 * 1: ROL (Role) <b>optional repeating</b><br>
 */
public class ADT_A54_TRAITANT extends AbstractGroup {

  /**
   * Creates a new ADT_A54_TRAITANT Group.
   */
  public ADT_A54_TRAITANT(final Group parent, final ModelClassFactory factory) {
