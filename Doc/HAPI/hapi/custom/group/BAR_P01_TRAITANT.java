...
/**
 * <p>
 * Represents the BAR_P01_TRAITANT Group. A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together. This Group contains the following
 * elements:
 * </p>
 * 1: ROL (Role) <b>optional repeating</b><br>
 */
public class BAR_P01_TRAITANT extends AbstractGroup {

  /**
   * Creates a new BAR_P01_TRAITANT Group.
   */
  public BAR_P01_TRAITANT(final Group parent, final ModelClassFactory factory) {
    super(parent, factory);
    try {
      this.add(ROL.class, false, true);
    } catch (final HL7Exception e) {
      CPageLogFactory.getLog(this.getClass()).error("Unexpected error creating BAR_A14_PROCEDURE - this is probably a bug in the source code generator.", e);
    }
  }
