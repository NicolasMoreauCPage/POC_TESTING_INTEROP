 ...
 */
public class ADT_A01_RESPONSABLE extends AbstractGroup {

  /**
   * Creates a new ADT_A01_RESP Group.
   */
  public ADT_A01_RESPONSABLE(final Group parent, final ModelClassFactory factory) {
