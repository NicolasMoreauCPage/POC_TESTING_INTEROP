...
INITIAL_EVENTS: Set[str] = {
    "A01",  # Admission (inpatient)
    "A04",  # Enregistrement consultation externe (outpatient)
    "A05",  # Pré-admission (inpatient à venir)
}
...
ALLOWED_TRANSITIONS: Dict[str, Set[str]] = {
    "A01": {
        ...
        "A06",  # Mutation vers consult/urgence
        "A07",  # Retour de consult/urgence
    },
    "A04": {
        "A03",  # Fin de consultation/visite
        "A04",
        "A06",
        "A07",
        "A11",
    ...
    "A12": {
        ...
        "A21",
        "A22",
        # A52/A53 et Z8x non autorisés en PAM FR > 2.8
        "Z99",
    },
    "A13": {
        "A02",
    ...
    # A52/A53 supprimés (non autorisés en PAM FR > 2.8)
    "A54": {
        "A02",
        "A03",
        "A11",
    ...
    # Z80/Z81/Z82/Z83/Z84/Z85 supprimés (non autorisés en PAM FR > 2.8)
    "Z99": {
        "A01",
        "A02",
        "A03",
...
WORKFLOW_GRAPH = {
    ...
    "transitions": [
        ...
        # Z80 supprimé (non autorisé PAM FR > 2.8)
    ],
}
